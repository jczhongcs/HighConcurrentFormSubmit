...
public interface CourseDao {
    ...
    @Insert("insert into course_info(user_id,course_id,course_name,course_start_date,course_end_date)values(" +
            "#{userId},#{courseId},#{courseName},#{courseStartDate},#{courseEndDate})")
